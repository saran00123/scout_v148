...
.method private static addCommand(Landroid/graphics/Path;[FCC[F)V
    ...
    sparse-switch v11, :sswitch_data_31a
    ...
    if-ge v9, v1, :cond_308

    const/16 v1, 0x41

    if-eq v11, v1, :cond_2c2

    const/16 v1, 0x43

    if-eq v11, v1, :cond_297

    const/16 v5, 0x48

    if-eq v11, v5, :cond_289

    const/16 v5, 0x51

    if-eq v11, v5, :cond_268

    const/16 v6, 0x56

    if-eq v11, v6, :cond_25a

    const/16 v6, 0x61

    if-eq v11, v6, :cond_20d

    const/16 v6, 0x63

    if-eq v11, v6, :cond_1e0

    const/16 v15, 0x68

    if-eq v11, v15, :cond_1d3
    ...
    if-eq v11, v14, :cond_1a8

    const/16 v14, 0x4c

    if-eq v11, v14, :cond_197
    ...
    if-eq v11, v4, :cond_b9

    const/16 v1, 0x74

    if-eq v11, v1, :cond_91
