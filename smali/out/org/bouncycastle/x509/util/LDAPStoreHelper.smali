...
.method private createAttributeCertificates(Ljava/util/List;Lorg/bouncycastle/x509/X509AttributeCertStoreSelector;)Ljava/util/Set;
    ...
    :try_end_33
    .catch Lorg/bouncycastle/x509/util/StreamParsingException; {:try_start_14 .. :try_end_33} :catch_e
...
.method private createCerts(Ljava/util/List;Lorg/bouncycastle/x509/X509CertStoreSelector;)Ljava/util/Set;
    ...
    invoke-interface {v0, v2}, Ljava/util/Set;->add(Ljava/lang/Object;)Z
    :try_end_33
    .catch Ljava/lang/Exception; {:try_start_14 .. :try_end_33} :catch_e
...
.method private createCrossCertificatePairs(Ljava/util/List;Lorg/bouncycastle/x509/X509CertPairStoreSelector;)Ljava/util/Set;
    ...
    :try_end_27
    .catch Lorg/bouncycastle/x509/util/StreamParsingException; {:try_start_c .. :try_end_27} :catch_28
    .catch Ljava/security/cert/CertificateParsingException; {:try_start_c .. :try_end_27} :catch_69
    .catch Ljava/io/IOException; {:try_start_c .. :try_end_27} :catch_69
    ...
    invoke-interface {v0, v2}, Ljava/util/Set;->add(Ljava/lang/Object;)Z
    :try_end_69
    .catch Ljava/security/cert/CertificateParsingException; {:try_start_28 .. :try_end_69} :catch_69
    .catch Ljava/io/IOException; {:try_start_28 .. :try_end_69} :catch_69
...
.method private search([Ljava/lang/String;Ljava/lang/String;[Ljava/lang/String;)Ljava/util/List;
    ...
    :try_end_fb
    .catch Ljavax/naming/NamingException; {:try_start_ad .. :try_end_fb} :catch_108
    .catchall {:try_start_ad .. :try_end_fb} :catchall_101
    ...
    :try_end_100
    .catch Ljava/lang/Exception; {:try_start_fd .. :try_end_100} :catch_10b
