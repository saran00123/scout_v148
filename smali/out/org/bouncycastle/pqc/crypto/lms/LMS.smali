...
.method public static verifySignature(Lorg/bouncycastle/pqc/crypto/lms/LMSPublicKeyParameters;Lorg/bouncycastle/pqc/crypto/lms/LMSContext;)Z
    ...
    invoke-interface {v1, v0, v7, v6}, Lorg/bouncycastle/crypto/Digest;->update([BII)V

    invoke-static {v2, v1}, Lorg/bouncycastle/pqc/crypto/lms/LmsUtils;->u32str(ILorg/bouncycastle/crypto/Digest;)V

    const/16 v6, -0x7d7e

    invoke-static {v6, v1}, Lorg/bouncycastle/pqc/crypto/lms/LmsUtils;->u16str(SLorg/bouncycastle/crypto/Digest;)V

    array-length v6, p1

    invoke-interface {v1, p1, v7, v6}, Lorg/bouncycastle/crypto/Digest;->update([BII)V
    ...
    invoke-static {v6, v1}, Lorg/bouncycastle/pqc/crypto/lms/LmsUtils;->u32str(ILorg/bouncycastle/crypto/Digest;)V

    invoke-static {v8, v1}, Lorg/bouncycastle/pqc/crypto/lms/LmsUtils;->u16str(SLorg/bouncycastle/crypto/Digest;)V
    ...
    invoke-interface {v1, v6, v7, v8}, Lorg/bouncycastle/crypto/Digest;->update([BII)V

    array-length v6, v5

    invoke-interface {v1, v5, v7, v6}, Lorg/bouncycastle/crypto/Digest;->update([BII)V
