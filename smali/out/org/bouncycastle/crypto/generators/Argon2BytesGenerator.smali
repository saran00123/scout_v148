...
.method private fillFirstBlocks([B[B)V
    ...
    invoke-static {v1, p2, v4}, Lorg/bouncycastle/util/Pack;->intToLittleEndian(I[BI)V

    invoke-static {v1, v0, v4}, Lorg/bouncycastle/util/Pack;->intToLittleEndian(I[BI)V

    const/16 v4, 0x400

    invoke-direct {p0, p2, p1, v2, v4}, Lorg/bouncycastle/crypto/generators/Argon2BytesGenerator;->hash([B[BII)V
    ...
    invoke-direct {p0, v0, p1, v2, v4}, Lorg/bouncycastle/crypto/generators/Argon2BytesGenerator;->hash([B[BII)V
...
.method private hash([B[BII)V
    ...
    invoke-virtual {v2, v0, v1, p4}, Lorg/bouncycastle/crypto/digests/Blake2bDigest;->update([BII)V

    array-length p4, p1

    invoke-virtual {v2, p1, v1, p4}, Lorg/bouncycastle/crypto/digests/Blake2bDigest;->update([BII)V
    ...
    invoke-virtual {v3, p1, v1, v0}, Lorg/bouncycastle/crypto/digests/Blake2bDigest;->update([BII)V

    invoke-virtual {v3, v2, v1}, Lorg/bouncycastle/crypto/digests/Blake2bDigest;->doFinal([BI)I

    const/16 p1, 0x20

    invoke-static {v2, v1, p2, p3, p1}, Ljava/lang/System;->arraycopy(Ljava/lang/Object;ILjava/lang/Object;II)V
    ...
    invoke-virtual {v3, v2, v1, v5}, Lorg/bouncycastle/crypto/digests/Blake2bDigest;->update([BII)V
    ...
    invoke-virtual {p1, v2, v1, p4}, Lorg/bouncycastle/crypto/digests/Blake2bDigest;->update([BII)V
