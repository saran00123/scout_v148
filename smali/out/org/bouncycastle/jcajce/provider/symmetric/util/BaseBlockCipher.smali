...
.method protected engineDoFinal([BII[BI)I
    ...
    move-result p2
    :try_end_1e
    .catch Lorg/bouncycastle/crypto/OutputLengthException; {:try_start_a .. :try_end_1e} :catch_2b
    .catch Lorg/bouncycastle/crypto/DataLengthException; {:try_start_a .. :try_end_1e} :catch_20
...
.method protected engineDoFinal([BII)[B
    ...
    move-result p2
    :try_end_1c
    .catch Lorg/bouncycastle/crypto/DataLengthException; {:try_start_16 .. :try_end_1c} :catch_32
...
.method protected engineGetParameters()Ljava/security/AlgorithmParameters;
    ...
    invoke-virtual {v0, v1}, Ljava/security/AlgorithmParameters;->init(Ljava/security/spec/AlgorithmParameterSpec;)V
    :try_end_b5
    .catch Ljava/lang/Exception; {:try_start_9f .. :try_end_b5} :catch_b6
...
.method protected engineInit(ILjava/security/Key;Ljava/security/spec/AlgorithmParameterSpec;Ljava/security/SecureRandom;)V
    ...
    if-eq v7, v11, :cond_163

    const/4 v5, 0x5

    if-eq v7, v5, :cond_163
    ...
    :try_end_16c
    .catch Ljava/lang/Exception; {:try_start_169 .. :try_end_16c} :catch_50f
    ...
    :cond_497
    if-eq v0, v11, :cond_4c7

    if-eq v0, v10, :cond_4c0

    if-eq v0, v3, :cond_4c7

    if-ne v0, v8, :cond_4a0
    ...
    invoke-interface {v0, v3, v2}, Lorg/bouncycastle/jcajce/provider/symmetric/util/BaseBlockCipher$GenericBlockCipher;->init(ZLorg/bouncycastle/crypto/CipherParameters;)V
    ...
    :try_end_4fa
    .catch Ljava/lang/IllegalArgumentException; {:try_start_4a0 .. :try_end_4fa} :catch_4be
    .catch Ljava/lang/Exception; {:try_start_4a0 .. :try_end_4fa} :catch_4bc
...
.method protected engineUpdate([BII[BI)I
    ...
    move-result p1
    :try_end_15
    .catch Lorg/bouncycastle/crypto/DataLengthException; {:try_start_a .. :try_end_15} :catch_16
